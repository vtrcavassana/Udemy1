...
VALUES
  ...
  ('Mathilde', 'Eichmann');
INSERT INTO
  produtos (nome, departamento, preco, peso)
VALUES
...
INSERT INTO
  pedidos (users_id, produtos_id, pago)
VALUES
  (41, 100, true),
  (27, 99, false),
  (50, 72, false),
...
-- juntar users e pedidos, mostrando o primeiro nome, último nome e se o pedido foi pago ou não
SELECT
  primeiroNome,
  ultimoNome,
  pago
FROM
  users
  JOIN pedidos ON users.id = pedidos.users_id;